...
type Manifest struct {
	...
	// Indicates whether this is a manifest that was manually uploaded by the user, as opposed to being internally generated by the Assisted Service
	IsCustomManifest *bool `json:"is_custom_manifest,omitempty"`
}
