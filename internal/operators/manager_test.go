...
var _ = Describe("Operators manager", func() {
	...
	Context("GenerateManifests", func() {
		It("Check YAMLs of all supported OLM operators", func() {
			...
			manifestsAPI.EXPECT().CreateClusterManifestInternal(gomock.Any(), gomock.Any(), string(models.ManifestManifestSourceSystemGenerated)).DoAndReturn(
				func(ctx context.Context, params operations.V2CreateClusterManifestParams, manifestSource string) (*models.Manifest, error) {
