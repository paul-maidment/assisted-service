...
type Manifest struct {
	...
	// Indicates the source of this manifest
	// Enum: [user_supplied system_generated unknown]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["user_supplied","system_generated","unknown"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// ManifestManifestSourceUserSupplied captures enum value "user_supplied"
	ManifestManifestSourceUserSupplied string = "user_supplied"

	// ManifestManifestSourceSystemGenerated captures enum value "system_generated"
	ManifestManifestSourceSystemGenerated string = "system_generated"

	// ManifestManifestSourceUnknown captures enum value "unknown"
	ManifestManifestSourceUnknown string = "unknown"
)
